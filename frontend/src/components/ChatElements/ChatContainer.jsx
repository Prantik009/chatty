...
export const ChatContainer = () => {
  const { messages, getMessages, isMessageLoading, selectedUser, subscribeToMessages, unsubscribeFromMessages } = userChatStore();
  const {authUser}  = useAuthStore()
  const messageEndRef = useRef(null)

  //to get all the message between the current user (ME) and the other user (selected user)
  useEffect(() => {
